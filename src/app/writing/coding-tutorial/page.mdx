...
#### I kind of clickbaited you, but wait, if you think, it makes sense.

Tutorials are literally learning about something you don't know and replicating it? But this is more of a personalized entry... mmm, maybe i'll change this soon, but I can't really think of anything lol.
...
export const meta = {
  ...
  date: "5-5-2025",
  description:
    "Showing the tutorial of how to achieve Anthony's current position.",
  status: "Published",
};
